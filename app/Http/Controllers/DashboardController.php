...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $lotesPorVencer = \App\Models\Lote::porVencer(30)->count();
        $lotesVencidos = \App\Models\Lote::vencidos()->count();
        ...
        return view('dashboard.index', compact(
            ...
            'productosStockBajo', 'lotesPorVencer', 'lotesVencidos', 'dias', 'meses', 'metodosPago', 'ventasCategoria',
