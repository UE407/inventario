...
@section('content')
    ...
    <div class="cards">
        <div class="stat blue">
            ...
            <div><div class="num">{{ $moneda }} {{ number_format($totalVentas, 2) }}</div><div class="label">Total vendido</div></div>
        ...
        <div class="stat purple">
            ...
            <div><div class="num">{{ $moneda }} {{ number_format($ticketPromedio, 2) }}</div><div class="label">Ticket promedio</div></div>
            <i class="fa-solid fa-calculator bg-ico"></i>
        </div>
        <div class="stat lime">
            <i class="fa-solid fa-percent icon"></i>
            <div><div class="num">{{ $moneda }} {{ number_format($impuestos, 2) }}</div><div class="label">IVA recaudado</div></div>
