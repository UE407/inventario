...
@section('content')
    ...
    <div class="cards">
        <div class="stat blue">
            ...
            <div><div class="num">{{ $moneda }} {{ number_format($valorCompra, 2) }}</div><div class="label">Valor a costo</div></div>
            <i class="fa-solid fa-boxes-stacked bg-ico"></i>
        </div>
        <div class="stat orange">
            <i class="fa-solid fa-tags icon"></i>
            <div><div class="num">{{ $moneda }} {{ number_format($valorVenta, 2) }}</div><div class="label">Valor a venta</div></div>
