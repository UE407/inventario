        ...
        <form method="POST" action="{{ route('configuracion.empresa.update') }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <div class="help">Ej: Q, $, €, S/</div>
                </div>

                <div class="form-group">
                    <label>Porcentaje de Impuesto / IVA (%) <span style="color:#64748b;font-weight:normal">(Opcional)</span></label>
                    <input type="number" name="igv" step="0.01" min="0" max="100"
                           class="form-control @error('igv') invalid @enderror" value="{{ old('igv', $empresaCfg->igv) }}" placeholder="0.00">
                    <div class="help">Ingresa el % de impuesto (ej: 12) o déjalo en 0 si la empresa NO cobra impuestos.</div>
