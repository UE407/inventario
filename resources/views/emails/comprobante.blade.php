...
@php $monedaEmail = $venta->empresa->moneda ?? 'Q'; @endphp
                ...
                <tr><td style="padding:6px 0;color:#6b7480">Total</td>
                    <td style="padding:6px 0;text-align:right;font-weight:800;color:#1583b8">{{ $monedaEmail }} {{ number_format($venta->total,2) }}</td></tr>
                <tr><td style="padding:6px 0;color:#6b7480">Estado DTE / FE</td>
